...
gulp.task('scripts-deploy', function() {
    ...
    return gulp.src(['app/scripts/src/_includes/**/*.js', 
                     'app/scripts/src/jquery/dist/jquery.js',
                     'app/scripts/src/bootstrap/dist/js/bootstrap.js',
                     'app/scripts/src/wow/dist/wow.js',
                     'app/scripts/src/angular.min.js',
                     'app/scripts/src/funcoes.js'])
                //prevent pipe breaking caused by errors from gulp plugins
                .pipe(plumber())
                //this is the filename of the compressed version of our JS
                .pipe(concat('app.js'))
